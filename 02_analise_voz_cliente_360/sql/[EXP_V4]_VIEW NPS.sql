...
SELECT * FROM NPS_ONCOLOGIA
  UNION ALL
SELECT * FROM NPS_INTERNACAO
  UNION ALL
SELECT * FROM NPS_LABORATORIO
  UNION ALL
SELECT * FROM NPS_EXAME_IMAGEM
  UNION ALL
SELECT * FROM NPS_MATERNIDADE_INTER
  UNION ALL
SELEct * FROM NPS_EMERGENCIAS
  UNION ALL
SELECT * FROM NPS_REDE_PROPRIA
  UNION ALL
SELECT * FROM NPS_REALVACINA
  UNION ALL
SELECT * FROM NPS_HEMODIALISE_CONV
  UNION ALL
SELECT * FROM NPS_LCC
  UNION ALL
SELECT * FROM NPS_DCLI_INTER
  UNION ALL
SELECT * FROM NPS_DCLI_AMB
  UNION ALL
SELECT * FROM NPS_UTIS

/*------------------------------------------------------------------------------------------------
#                VERIFICA��O DE PROCESSAMENTO DE DADOS E PERFORMANCE DA CARGA                    #
------------------------#-------------------------#-----------------#--------------#-------------#
#     TABLESPACE        #      TEMPO INICIAL      #  LINHAS TOTAIS  # REALIZADO EM # RESPONSAVEL #
------------------------#-------------------------#-----------------#--------------#-------------#
# NPS_ONCOLOGIA         # 50 LINHAS EM 01,112 SEG #     000.044     #  04/03/2026  #    26521    #
# NPS_INTERNACAO        # 50 LINHAS EM 00,766 SEG #     000.170     #  04/03/2026  #    26521    #
# NPS_LABORATORIO       # 50 LINHAS EM 01,571 SEG #     000.431     #  04/03/2026  #    26521    #
# NPS_EXAME_IMAGEM      # 50 LINHAS EM 01,611 SEG #     000.910     #  04/03/2026  #    26521    #
# NPS_MATERNIDADE_INTER # 50 LINHAS EM 02,506 SEG #     000.920     #  04/03/2026  #    26521    #
# NPS_EMERGENCIAS       # 50 LINHAS EM 02,043 SEG #     001.794     #  04/03/2026  #    26521    #
# NPS_REDE_PROPRIA      # 50 LINHAS EM 02,435 SEG #     001.942     #  04/03/2026  #    26521    #
# NPS_REALVACINA        # 50 LINHAS EM 02,099 SEG #     001.954     #  04/03/2026  #    26521    #
# NPS_HEMODIALISE_CONV  # 50 LINHAS EM 03,255 SEG #     001.964     #  04/03/2026  #    26521    #
# NPS_LCC               # 50 LINHAS EM 03,458 SEG #     001.964     #  04/03/2026  #    26521    #
# NPS_DCLI_INTER        # 50 LINHAS EM 04,165 SEG #     001.966     #  04/03/2026  #    26521    #
# NPS_DCLI_AMB          # 50 LINHAS EM 05,210 SEG #     001.981     #  04/03/2026  #    26521    #
# NPS_UTIS              # 50 LINHAS EM 07,662 SEG #     001.986     #  04/03/2026  #    26521    #
----------------------#-------------------------#-----------------#--------------#-------------#*/
--ESTRUTURA ANTERIOR LEVA 172,231 SEG PARA 50 LINHAS